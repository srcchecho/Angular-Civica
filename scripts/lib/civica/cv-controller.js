    ...
    var CVBaseController = (function () {
                ...
                for (var i = 0; i < columnas.length; i++) {
                    ...
                    if (!cvUtil.Utilidades.comprobarObjetoVacio(filterJson)) {
                        for (var j = 0; j < filterJson.length; j++) {
                            ...
                            if (elemento instanceof app.Escenario) {
                                elemento = elemento;
                                if (c == "estado")
                                    if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.estado))
                                        elemento.estado2 = elemento.getCadenaEstado();
                                if (c == "selloEditorial")
                                    if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.selloEditorial))
                                        elemento.sello2 = elemento.getCadenaSello();
                                if (c == "canalPropietario")
                                    if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.canalPropietario))
                                        elemento.propietario2 = elemento.canalPropietario.getCadenaCompleta();
                            }
                            if (elemento instanceof app.Presupuesto) {
                                elemento = elemento;
                                if (c == "estado")
                                    if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.estado))
                                        elemento.estado2 = elemento.getEstadoPresupuesto();
                                if (c == "titulo")
                                    if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.propietario))
                                        elemento.titulo = elemento.getCadenaCompletaPropietario();
                            }
                    ...
                    for (var i = 0; (i < columnas.length && !encontrado); i++) {
                        ...
                        if (elemento instanceof app.Escenario) {
                            ...
                            if (columnas[i] == "estado")
                                if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.estado))
                                    elemento.estado2 = elemento.getCadenaEstado();
                            if (columnas[i] == "selloEditorial")
                                if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.selloEditorial))
                                    elemento.sello2 = elemento.getCadenaSello();
                            if (columnas[i] == "canalPropietario")
                                if (!cvUtil.Utilidades.comprobarObjetoNulo(elemento.canalPropietario))
                                    elemento.propietario2 = elemento.canalPropietario.getCadenaCompleta();
                        }
                        if (elemento instanceof app.Presupuesto) {
        ...
        **/
        ...
        CVBaseController.prototype.volver = function () {
            ...
            if (ctrl instanceof app.ListaEscenariosController)
                ctrl.volver();
            if (ctrl instanceof app.ListaPresupuestosController)
                ctrl.volver();
